...
SOURCES := src/main.c src/app.c src/common.c src/buffer.c src/account.c src/codec.c \
           src/crypto.c src/imap_parser.c src/mime.c src/mailto.c src/oauth.c src/tls.c \
           src/imap.c src/smtp.c src/storage.c src/network_task.c src/gui.c src/gui_runtime.c src/gui_actions.c src/gui_mailto.c \
           src/gui_window.c src/gui_dialogs.c src/gui_compose.c src/gui_folders.c src/gui_messages.c src/gui_preview.c src/charset.c src/i18n.c src/banner_data.c
