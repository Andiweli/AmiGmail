...
void init_label_tree_render_hook(AmgGui *gui)
{
    ...
    gui->label_tree_render_hook.h_Entry = (__typeof__(gui->label_tree_render_hook.h_Entry))HookEntry;
                                      ...
                                      const char *text, ULONG user_data)
{
    if (gui && gui->system_label_render_hook.h_Entry &&
        ...
        return AllocListBrowserNode(
            ...
            LBNCA_RenderHook,
            (ULONG)(uintptr_t)&gui->system_label_render_hook,
                                            ...
                                            ULONG user_data)
{
    ...
    if (gui && gui->label_tree_render_hook.h_Entry &&
        ...
        return AllocListBrowserNode(
            ...
            LBNA_Column, 0,
            LBNCA_RenderHook,
            (ULONG)(uintptr_t)&gui->label_tree_render_hook,
