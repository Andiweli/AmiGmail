                          ...
                          unsigned long contact_id, AmgError *error)
{
    ...
    dialog = WindowObject,
        WA_Title, editing
            ? T(MSG_AMIGMAIL_EDIT_CONTACT, "AmiGmail - Edit contact")
            : T(MSG_AMIGMAIL_NEW_CONTACT, "AmiGmail - New contact"),
...
void gui_contacts_dialog(AmgGui *gui, AmgError *error)
{
    ...
    dialog = WindowObject,
        WA_Title, T(MSG_AMIGMAIL_CONTACT_MANAGEMENT, "AmiGmail - Contact management"),
        WA_Flags, WFLG_CLOSEGADGET | WFLG_DRAGBAR | WFLG_DEPTHGADGET |
                               ...
                               struct Gadget *target, AmgError *error)
{
    ...
    dialog = WindowObject,
        WA_Title, T(MSG_AMIGMAIL_SELECT_CONTACTS, "AmiGmail - Select contacts"),
        WA_Flags, WFLG_CLOSEGADGET | WFLG_DRAGBAR | WFLG_DEPTHGADGET |
                  WFLG_SIZEGADGET | WFLG_ACTIVATE,
        WA_IDCMP, IDCMP_CLOSEWINDOW | IDCMP_GADGETUP | IDCMP_RAWKEY,
        WA_PubScreen, gui->screen,
